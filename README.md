...
**Custom Strategy** — Develop and link your own strategies within the same codebase. See [CUSTOM_STRATEGY.md](CUSTOM_STRATEGY.md) for a full developer guide: the `Strategy` trait API, all `StrategyContext` fields, the five integration steps, common gotchas, and a ready-to-run test harness.
